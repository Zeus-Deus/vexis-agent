...
default; codex and opencode optional) — Telegram in, MCP tools out, agent
CLI in the middle. Not a new agent.

## How to edit this file

AGENTS.md is a behaviour manual — short, direct, prescriptive.
...
(`tests/test_agents_md_invariants.py`) fails when this file
grows past 347 lines. The fix is extraction — bump only when
